...
const Sidebar = () => {
   return (
   <>
      <div className="container absolute left-0 h-screen w-56 bg-white shadow-md flex flex-col">
        <div className="pb-4">
          ...
          <div className="px-4">
            <p className="text-black text-xs mb-2">Main</p>

            <ul className="">
              <li className="flex items-center gap-3 p-1 rounded-lg bg-orange-100 text-orange-500 cursor-pointer">
                <Home size={15} />
               <p className="text-sm">Dashboard</p>
              </li>

              <li className="flex items-center gap-3 p-1 rounded-lg hover:bg-orange-100 hover:text-orange-500 cursor-pointer">
                <Package size={15} />
